// Package storetest provides backend-conformance suites for the four storekit
...
// backends and classifies failures with errors.As against the storekit-canonical
